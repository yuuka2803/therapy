        ...
        <div class="flex h-[100px] drop-shadow-xl text-white" style="background-color:#709892">
            ...
            <div class="flex-none w-1/2 text-xl">
                <div class="flex items-stretch justify-end space-x-6">
                    <router-link to="/form">
                        <div
                            class="flex-none hover:bg-blue-300/50 text-md w-[130px] h-[100px] flex justify-center items-center">
                    ...
                    <div class="flex-none hover:bg-blue-300/50 text-md w-[190px] h-[100px] flex justify-center items-center space-x-2"
                        v-show="isLogin">
                    ...
                    <div v-show="isVisible" class="absolute w-48 mt-[70px] bg-white round-md">
                        <router-link to="/history"
                            class="block px-4 py-2 text-sm capitalize text-gray-700 hover:bg-red-500">
                            ประวัติการใช้งาน
                        </router-link>
                    ...
                    <router-link to="/homeuser">
                        <div class=" text-md w-[50px] h-[100px] flex justify-center items-center mr-6">
                            <button>
...
export default {
    ...
    async created() {
        ...
        console.log(useUserStore().getName, "get name navbar");
    },
    mounted() {

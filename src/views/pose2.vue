        ...
        <div class="flex">
            <div class="flex-none w-1/2 flex justify-center">
                <div>
                    ...
                    <div class="">
                        <iframe src="http://127.0.0.1:5500/pose2.html" frameborder="0" width="400" height="480" allow="camera"></iframe>
                    </div>
                    <div class="flex justify-center">
                        <div class="flex-none pt-12">
                            <router-link to="/exthree">
            ...
            <div class="flex-none w-1/2 flex items-center justify-center">
                <div class="items-center">
                    <p class="text-3xl text-center pb-5 mt-16">ท่าที่ 2</p>
                    <div class="flex items-center justify-center"><img class="justify-self-center" src="https://i.postimg.cc/wMNH4DXT/shoulder-flexion.png" width="520px"></div>
